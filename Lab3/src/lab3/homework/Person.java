...
public abstract class Person implements Node, Comparable<Person> {
    ...
    /**
     * lista relatiilor pe care le are persona reprezentata de obiectul din this
     * Node-persoana sau compania cu care persoana din this are o relatie
     * String-tipul de relatie
     */
